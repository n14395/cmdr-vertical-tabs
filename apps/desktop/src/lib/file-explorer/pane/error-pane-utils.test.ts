...
// `renderErrorMarkdown` takes trusted markdown composed on the FE (template
// literal + params already escaped via `esc(...)` in the message factories).
// These exercise the snarkdown wrapper.
